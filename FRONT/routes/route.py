...
def get_familia_generador_data():
    ...
    familias = load_data('/home/ariel/Documents/Taller_Domingo_LINKED_LIST/Taller_Domingo_2json/src/main/java/Data/Familia.json')
    generadores = load_data('/home/ariel/Documents/Taller_Domingo_LINKED_LIST/Taller_Domingo_2json/src/main/java/Data/Generador.json')
...
def view_buscar_familia(criterio, texto):
    ...
    if(r.status_code == 200):
        if type(data1["data"]) is dict:
            ...
            return render_template ('fragmento/familia/lista.html', lista_familia = data1["data"])

    else:
        return render_template ('fragmento/familia/lista.html', lista_familia = [], message = 'No existe el elemento')
    

@router.route('/admin/familia/order/<atributo>/<tipo>/<metodo>')
def view_order_familia(atributo, tipo, metodo):
    url = 'http://localhost:8086/api/familia/list/order/'+atributo+"/"+tipo+"/"+metodo
